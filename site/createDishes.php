        ...
        <div class="row">
            ...
            <div class="col-md-8" id="form">
                <div class="form-group">
                    <form action="./php/createDishes.php" method="post">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="review">Dish Name</label>
                            <input type="username" name="dishName" class="form-control is-valid" ng-model="username">
                        </div>

                        <div class="form-group">
                            <label for="review">Cuisine Type</label>
                            <input type="username" name="cuisineType" class="form-control is-valid" ng-model="username">
                        </div>
